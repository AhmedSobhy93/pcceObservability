...
public class IntegrationController {
    ...
    public List<IntegrationCapability> capabilities() {
        return List.of(
                ...
                new IntegrationCapability("PCCE Live Data", "Realtime agent, skill group and call type telemetry", "CUIC Live Data API and WebSocket", "Config ready", "Configure Live Data host, token path and WebSocket port from CUIC datasource"),
